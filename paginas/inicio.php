<div class="inicio">
    ...
    <div id="carouselSlider" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-indicators">
            ...
            <button type="button" data-bs-target="#carouselSlider" data-bs-slide-to="1" style="background-color:rgb(33,97,140);" aria-label="Slide 2"></button>
            <button type="button" data-bs-target="#carouselSlider" data-bs-slide-to="2" style="background-color:rgb(33,97,140);" aria-label="Slide 3"></button>
        </div>
