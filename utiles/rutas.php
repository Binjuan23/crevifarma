...
$ruta = ["css" => "./assets/css/styles.css", "listado" => "./index.php?id=listado", "indice" => "./index.php", "login" => "index.php?id=login", 'script' => "./assets/javascript/script.js", "buscar" => "index.php?id=buscar", "jquery" => "./assets/jquery/jquery-3.6.4.min.js", "validate" => "./assets/jquery/jquery.validate.min.js"];
switch ($id) {
