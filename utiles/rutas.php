...
$ruta = ["css" => "./assets/css/styles.css", "listado" => "./index.php?id=listado", "indice" => "./index.php", "login" => "index.php?id=login", 'script' => "./assets/javascript/script.js", "buscar" => "index.php?id=buscar"];
switch ($id) {
